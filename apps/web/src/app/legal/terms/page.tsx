...
export default function TermsPage(): JSX.Element {
  return (
    <div className="space-y-6 text-sm leading-relaxed text-slate-700">
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-slate-900">2. Accounts &amp; access</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-slate-900">4. Customer data</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-slate-900">5. Availability &amp; support</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-slate-900">7. Warranties &amp; liability</h2>
        <p>
