    ...
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <div className="grid gap-4 lg:grid-cols-[220px_1fr]">
          <div className="space-y-1 rounded-xl border border-outline-variant bg-inverse-surface p-2">
          ...
          <div className="space-y-3 rounded-xl border border-outline-variant bg-inverse-surface p-4">
            {selected ? (
              <>
                <div className="flex items-center justify-between">
                  <div>
      ...
      {showCreate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-on-surface/50 p-4">
          <div className="w-full max-w-lg rounded-xl border border-outline-variant bg-inverse-surface p-4">
            ...
            <div className="mt-3 grid gap-2">
              <input
                ...
                className="rounded border border-outline-variant bg-inverse-surface px-3 py-2 text-sm"
              />
              <input
