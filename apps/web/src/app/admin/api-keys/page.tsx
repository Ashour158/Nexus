      ...
      {createdKey && (
        <div className="rounded-2xl border border-success/40 bg-success/10 p-5">
          ...
          <div className="mt-3 flex items-center gap-2">
            <code className="flex-1 overflow-x-auto rounded-lg border border-success/30 bg-inverse-surface px-3 py-2 font-mono text-sm text-success">
              {createdKey.key}
            </code>
            <button
              type="button"
        ...
        {keysQuery.isLoading ? (
          ...
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-outline-variant">
              {keys.map((key) => (
                <tr key={key.id} className="hover:bg-inverse-surface/40">
        ...
        <div className="fixed inset-0 z-50 flex justify-end bg-on-surface/50" onClick={resetForm}>
          ...
          >
            <div className="flex items-center justify-between border-b border-outline-variant px-6 py-4">
              ...
              <button type="button" onClick={resetForm} className="rounded-lg p-1.5 text-on-surface-variant hover:bg-surface-container-highest hover:text-white">
                <X className="h-5 w-5" />
              </button>
            </div>
