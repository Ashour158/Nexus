  ...
  return (
    <div className="space-y-6 text-sm leading-relaxed text-on-surface">
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-on-surface">1. Who we are</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-on-surface">2. Data we process</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-on-surface">3. Why we process it (legal bases)</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-on-surface">4. Multi-tenancy &amp; isolation</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-on-surface">5. Sub-processors &amp; sharing</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-on-surface">6. Retention</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-on-surface">7. Your rights</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-on-surface">8. Security</h2>
        <p>
      ...
      <section className="space-y-2">
        <h2 className="text-xl font-semibold text-on-surface">9. Changes</h2>
