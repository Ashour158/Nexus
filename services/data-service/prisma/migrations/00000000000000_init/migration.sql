...
CREATE TABLE "ScheduledDataJob" (
    ...
    CONSTRAINT "ScheduledDataJob_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "ImportMappingTemplate_tenantId_module_idx" ON "ImportMappingTemplate"("tenantId", "module");

-- CreateIndex
CREATE UNIQUE INDEX "ImportMappingTemplate_tenantId_module_name_key" ON "ImportMappingTemplate"("tenantId", "module", "name");

-- CreateIndex
CREATE UNIQUE INDEX "ImportMappingTemplate_id_tenantId_key" ON "ImportMappingTemplate"("id", "tenantId");

-- CreateIndex
CREATE INDEX "ScheduledDataJob_isActive_nextRunAt_idx" ON "ScheduledDataJob"("isActive", "nextRunAt");

-- CreateIndex
CREATE INDEX "ScheduledDataJob_tenantId_kind_idx" ON "ScheduledDataJob"("tenantId", "kind");

-- CreateIndex
CREATE UNIQUE INDEX "ScheduledDataJob_id_tenantId_key" ON "ScheduledDataJob"("id", "tenantId");

-- CreateIndex
CREATE INDEX "DataJobRun_tenantId_jobId_idx" ON "DataJobRun"("tenantId", "jobId");
...
-- AddForeignKey
ALTER TABLE "DataJobRun" ADD CONSTRAINT "DataJobRun_jobId_fkey" FOREIGN KEY ("jobId") REFERENCES "ScheduledDataJob"("id") ON DELETE CASCADE ON UPDATE CASCADE;
