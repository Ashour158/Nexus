...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <form onSubmit={onSubmit} className="space-y-5 rounded-xl border border-outline-variant bg-surface p-5">
        <div className="grid gap-4 md:grid-cols-2">
          <Field label="Default currency" hint="ISO 4217 code applied to new records">
            <input
              ...
              maxLength={8}
              className="w-full rounded border border-outline-variant bg-surface px-3 py-2 text-sm uppercase"
            />
          </Field>
          <Field label="From email" hint="Sender address for system notifications">
            <input
              ...
              className="w-full rounded border border-outline-variant bg-surface px-3 py-2 text-sm"
            />
          </Field>
