  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => setOpen(true)} className="rounded bg-indigo-600 px-3 py-2 text-sm font-medium">Create tenant</button>
      </div>
