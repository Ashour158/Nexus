...
interface BulkActionBarProps {
  ...
  onClear: () => void;
  queryKey: unknown[];
  /** Optional owner options; when provided the Reassign action shows a dropdown. */
  ownerOptions?: Array<{ id: string; name: string }>;
}

export function BulkActionBar({ entityType, selectedIds, onClear, queryKey, ownerOptions = [] }: BulkActionBarProps) {
