...
-- CreateIndex
CREATE INDEX "Activity_status_dueDate_reminderSentAt_idx" ON "Activity"("status", "dueDate", "reminderSentAt");

-- CreateIndex
CREATE INDEX "Activity_status_dueDate_overdueNotifiedAt_idx" ON "Activity"("status", "dueDate", "overdueNotifiedAt");
