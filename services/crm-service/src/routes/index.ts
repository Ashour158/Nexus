...
import { registerQuotasRoutes } from './quotas.routes.js';
...
export async function registerAllRoutes(
  ...
  await registerTasksRoutes(app, prisma, producer);
  await registerTimelineRoutes(app, prisma);
  await registerQuotasRoutes(app, prisma);
